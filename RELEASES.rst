...
* User functions pushed using duk_push_c_function() and duk_push_c_lightfunc()
  inherit from an intermediate prototype object (function ->
  %NativeFunctionPrototype% -> Function.prototype) which provides .name and
  .length getters (the virtual .name and .length properties of Duktape/C and
  lightfuncs have been removed); this change also allows .name and .length to
  be overridden using duk_def_prop() or Object.defineProperty() (GH-1493,
  GH-1494, GH-1515)
